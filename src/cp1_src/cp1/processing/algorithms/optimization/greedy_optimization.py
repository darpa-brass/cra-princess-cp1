...
#             for ta in self.constraints_object.candidate_tas:
#                 self.round_bandwidth_value(self.constraints_object.candidate_tas)
#
...
#                     comm_length = ta.compute_communication_length(channel.capacity, min_latency, self.constraints_object.guard_band, ta.bandwidth)
...
#                         value += ta.compute_value(ta.bandwidth)
#                         channel.value += ta.compute_value(ta.bandwidth)
