...
Utility module to hold any json utility functions.
...
from cra.mdl_data.mdl_bandwidth_rate import MDLBandwidthRate
from cra.mdl_data.mdl_bandwidth_set import MDLBandwidthSet
from cra.common.constants import Constants
...
def create_mdl_bandwidth_set(mdl_bandwidth_dict):
    ...
    :param mdl_bandwidth_dict: Output from file_to_json
    :type mdl_bandwidth_dict: dict
    ...
    for type in Constants.mdl_bandwidth_types:
        ...
        mdl_bandwidth_rates.append(MDLBandwidthRate(radioA_to_radioB_id, radioA_to_radioB_value, radioB_to_radioA_id, radioB_to_radioA_value))

    mdl_bandwidth_set = MDLBandwidthSet(mdl_bandwidth_rates[0], mdl_bandwidth_rates[1], mdl_bandwidth_rates[2], mdl_bandwidth_rates[3])
